...
namespace Code420.SfBlazorPlus.OrchestratorComponents.OrchestratorHorizontalMenu
{
    public partial class OrchestratorHorizontalMenu : ComponentBase
    {
        ...
        private void MyItemSelectedHandler(MenuEventArgs<OrchestratorMenuItem> args)
        {
            ...
            //OrchestratorRef.MenuItemSelectedAsync(args.Item.ItemId);
            if (args.Item.MenuItemCallback is not null) args.Item.MenuItemCallback(args.Item.ItemId);
        }
        ...
        private const string menuCssClass = "page__main-horizontal-menu";                   // CSS class assigned to the MenuBase component, used to build masterCssSelector
